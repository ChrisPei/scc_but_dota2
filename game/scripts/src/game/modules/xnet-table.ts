...
export class XNetTable {
     ...
     * @memberof XNetTable
     */
    SetTableValue<TName extends keyof XNetTableDefinitions, T extends XNetTableDefinitions[TName], K extends keyof T>(
        tname: TName,
        key: K,
        value: T[K]
    ) {
     ...
     * @memberof XNetTable
     */
    SetPlayerTableValue<TName extends keyof XNetTableDefinitions, T extends XNetTableDefinitions[TName], K extends keyof T>(
        playerId: PlayerID,
        tname: TName,
        key: K,
        value: T[K]
