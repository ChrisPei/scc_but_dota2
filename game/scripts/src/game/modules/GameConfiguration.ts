...
export class GameConfiguration extends ModuleBase {
    // public static DebugDraw: boolean = IsInToolsMode();
    ...
    Activate() {
        ...
        game.SetCustomGameForceHero(`npc_dota_hero_pudge`); // 设置强制英雄（会直接跳过英雄选择阶段并直接为所有玩家选择这个英雄）
