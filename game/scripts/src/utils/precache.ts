...
// 预载入KV文件中的所有资源
export function precacheEveryResourceInKV(kvFileList: string[], context: CScriptPrecacheContext) {
...
// 预载入资源列表
export function precacheResource(resourceList: string[], context: CScriptPrecacheContext) {
    resourceList.forEach(resource => {
        precacheResString(resource, context);
    });
}
export function precacheResString(res: string, context: CScriptPrecacheContext) {
...
// 预载入单位列表
export function precacheUnits(unitNamesList: string[], context?: CScriptPrecacheContext) {
    if (context != null) {
...
// 预载入物品列表
export function precacheItems(itemList: string[], context: CScriptPrecacheContext) {
...
export function precacheEverythingFromTable(kvTable: any, context: CScriptPrecacheContext) {
